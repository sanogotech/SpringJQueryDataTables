...
import com.macrosoft.service.PersonService;
...
public class MainController {
	...
	public ModelAndView index(Principal principal, Authentication authentication) {
		...
		mavIndex.addObject("myroles",  userDetails.getAuthorities());
